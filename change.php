...
error_reporting(E_ALL);
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $element_titre = $dom->getElementById('titre_page1');
        $element_sous_titre = $dom->getElementById('sous_titre_page1');
        $element_src_video = $dom->getElementById('src_video_page1');
        $element_texte_video = $dom->getElementById('texte_video_page1');
        ...
        $element_src_video->setAttribute('src', $src_video);
        $element_texte_video->nodeValue = $texte_video;
